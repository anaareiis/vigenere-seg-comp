...
os resultados dos dois criptogramas oficiais serão incorporados após
a disponibilização desses arquivos.
\end{abstract}
...
foram aprovados. Ainda falta validar o ataque com os dados oficiais.
...
frequência. A avaliação final de legibilidade depende dos dois
...
em dados controlados. Ainda é necessário avaliar os dois criptogramas
oficiais antes de concluir sobre as chaves do experimento.
